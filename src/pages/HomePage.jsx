    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundColor: "rgba(233, 92, 92, 0.47)",
            zIndex: 1,
          }}
        ></div>
      ...
      <Container className="py-5">
              ...
              <Card className="h-100 shadow-sm">
                ...
                <Card.Footer className="bg-white border-0 text-center">
                  <Button
                    ...
                    className="w-100"
                    style={{
                      borderColor: cornellRed,
                      color: cornellRed,
                      transition: "color 0.3s ease, background-color 0.3s ease",
                    }}
                    onMouseOver={(e) => {
                      e.currentTarget.style.color = "white";
                      e.currentTarget.style.backgroundColor = cornellRed;
                    }}
                    onMouseOut={(e) => {
                      e.currentTarget.style.color = cornellRed;
        ...
        <div className="text-center mt-4">
          <Link
            ...
            style={{ backgroundColor: cornellRed }}
          >
            View All Events
          </Link>
        </div>
